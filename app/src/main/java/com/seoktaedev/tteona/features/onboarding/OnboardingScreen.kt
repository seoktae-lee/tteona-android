    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Image(
                ...
                contentDescription = stringResource(R.string.onboarding_logoDesc),
                modifier = Modifier.height(42.dp),
            )
            Spacer(Modifier.height(18.dp))
            Text(stringResource(R.string.auth_tagline), fontSize = 16.sp, color = TteMediumGray)

            Spacer(Modifier.weight(1f))

            Box(Modifier.padding(horizontal = 24.dp)) {
                NextButton(stringResource(R.string.onboarding_start)) {
                    Haptics.light(view)
                    onNext()
                }
            }
...
private val heroSlides = listOf(
    ...
    HeroSlide(
        ...
        R.string.onboarding_slide4_title,
        R.string.onboarding_slide4_subtitle,
        Color(0xFFFF4F79),
        ...
        Column(Modifier.fillMaxSize()) {
            ...
            AnimatedContent(
                ...
                Column(
                    ...
                    Text(stringResource(heroSlides[index].titleRes), fontSize = 28.sp, fontWeight = FontWeight.Bold, color = TteDarkGray)
                    Text(
                        stringResource(heroSlides[index].subtitleRes),
                        fontSize = 16.sp,
                        color = TteMediumGray,
            ...
            Box(
                ...
                Text(
                    if (isLast) stringResource(R.string.onboarding_start) else stringResource(R.string.common_next),
                    fontSize = 17.sp,
...
private fun NicknameStep(
    ...
    Column(Modifier.fillMaxSize()) {
        Column(
            ...
            Text(stringResource(R.string.onboarding_nickname_title), fontSize = 30.sp, fontWeight = FontWeight.Bold, color = TteDarkGray, lineHeight = 38.sp)
            Text(stringResource(R.string.onboarding_nickname_subtitle), fontSize = 15.sp, color = TteMediumGray)
        }
        ...
        Box(Modifier.padding(horizontal = 24.dp)) {
            NextButton(stringResource(R.string.common_next), enabled = state == NicknameState.AVAILABLE, onClick = onNext)
        }
...
private fun PermissionStep(onNext: () -> Unit) {
    ...
    Column(Modifier.fillMaxSize()) {
        Column(
            ...
            Text(stringResource(R.string.onboarding_permission_title), fontSize = 30.sp, fontWeight = FontWeight.Bold, color = TteDarkGray, lineHeight = 38.sp)
            Text(stringResource(R.string.onboarding_permission_subtitle), fontSize = 15.sp, color = TteMediumGray)
        }
        ...
        Column(
            ...
            PermissionRow(
                ...
                title = stringResource(R.string.onboarding_permission_notification),
        ...
        Box(Modifier.padding(horizontal = 24.dp)) {
            ...
            NextButton(stringResource(R.string.common_next)) {
                when {
...
private fun PermissionRow(
    ...
    Row(
        ...
        Box(
            ...
            Text(
                if (isGranted) stringResource(R.string.onboarding_permission_granted) else stringResource(R.string.onboarding_permission_continue),
                fontSize = 13.sp,
                fontWeight = FontWeight.SemiBold,
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Row(
                ...
                Text(stringResource(R.string.onboarding_terms_agreeAll), fontSize = 16.sp, fontWeight = FontWeight.SemiBold, color = TteDarkGray)
            }
...
private fun TermsRow(
    ...
    Row(
        ...
        Box(
            ...
            Text(stringResource(R.string.onboarding_terms_required), fontSize = 11.sp, fontWeight = FontWeight.Medium, color = TteOrange)
        }
        Spacer(Modifier.weight(1f))
        Icon(
